...
function GuideToTextComplexityLowerGrade(){	
	...
	this.indd_filename = findFileNameWW(current_package.ycode, current_package.grade, current_package.unit, false, false, false, 'TextComplexity_' + current_lesson_type);

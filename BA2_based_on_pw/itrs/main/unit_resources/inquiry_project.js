...
function InquiryProject(){	
	...
	this.goals_and_materials = 	new GoalsAndMaterials(new Zone(document.pages.firstItem(), [140, 0, 300, 650]), 'goals_and_materials', 'Learning Goals');
...
Header.prototype.toHTML = function(){
	...
	text += process_paragraphs(this, this.header_textFrame.paragraphs.everyItem().getElements()).replace(/(Research and Inquiry Project:)/ig, '<small>$1</small><br>');
	if(region == 'texas'){
